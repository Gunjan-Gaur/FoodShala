...
<%  try
    {
      ...
      ps=con.prepareStatement("select image,title,id,category,price,title,address from items");
      rs=ps.executeQuery();
%>
<%
    while(rs.next())
...
%> 
        <tr valign="left">
          <div class="overflow-x:auto" style="display: inline-flex;"><br><br>
            <div class="">
               <img src="Images/<%=rs.getString("image") %>" class="ml-5" style="height:200px; width:200px;" alt="...">
            </div>
           ...
           <button class="button w-25 rounded-lg" style="margin-left: 70px; background-color: wheat;"><a href='OrderNow.jsp?id=<%=rs.getString("id")%>' style="text-decoration-style:none;">ORDER NOW</a></button>
            </form>
